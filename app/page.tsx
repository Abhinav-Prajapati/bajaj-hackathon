              ...
              <a href={link.link} target="_blank" rel="noopener noreferrer">
                {
                  <div className=" overflow-hidden bg-gradient-to-r from-[#00b3cc] to-[#5862e6] h-[8.5rem] w-[28rem] m-2 p-3 gola relative group hover:shadow-lg ">
                    ...
                    <div className=" group-hover:shadow-xl group-hover:scale-110 transition ease-in-out duration-75 gola_sm  h-8 bg-neutral-900 p-1 pl-3 rounded-lg absolute left-0 flex bottom-0 m-3 ">
